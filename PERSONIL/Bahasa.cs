...
namespace PERSONIL
{
    public partial class Bahasa : Form
    {
        ...
        void tampil()
        {
            da = new SqlDataAdapter("Select * from Bahasa where nip_nrp='" + t_nip_nrp.Text + "'", conn);
            ds = new DataSet();
            da.Fill(ds);
        ...
        private void Bahasa_Load(object sender, EventArgs e)
        {
            this.tampil();
        ...
        private void p_insert_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                perintahTambah.CommandText = "insert dbo.Bahasa values(@nama_bahasa, @keterangan, @nip_nrp)";

                perintahTambah.Parameters.AddWithValue("@nama_bahasa", t_nama_bahasa.Text);
                perintahTambah.Parameters.AddWithValue("@keterangan", t_keterangan.Text);
        ...
        private void p_update_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                perintahUbah.CommandText = "UPDATE Bahasa SET nama_bahasa=@nama_bahasa, keterangan=@keterangan, nip_nrp=@nip_nrp WHERE id_bahasa=@id_bahasa";

                //Console.WriteLine(t_id_bahasa.Text);

                perintahUbah.Parameters.AddWithValue("@id_bahasa", dataGridView1.Rows[dataGridView1.CurrentCell.RowIndex].Cells[0].Value.ToString());
                perintahUbah.Parameters.AddWithValue("@nama_bahasa", t_nama_bahasa.Text);
                perintahUbah.Parameters.AddWithValue("@keterangan", t_keterangan.Text);
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
                ...
                t_nama_bahasa.Text = row.Cells[1].Value.ToString();
                t_keterangan.Text = row.Cells[2].Value.ToString();
                t_nip_nrp.Text = row.Cells[3].Value.ToString();
        }
        ...
        private void p_delete_Click(object sender, EventArgs e)
        {
            ...
            perintahHapus.CommandText = "Delete Bahasa where id_bahasa=@id_bahasa";
            perintahHapus.Parameters.AddWithValue("@id_bahasa", dataGridView1.Rows[dataGridView1.CurrentCell.RowIndex].Cells[0].Value.ToString());
